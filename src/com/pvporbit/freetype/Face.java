...
public class Face extends Pointer {
	...
	public short getDescender() {
		return FreeType.FT_Get_descender(pointer);
	}

	public long getFaceFlags() {
		return FreeType.FT_Get_face_flags(pointer);
	}

	public long getFaceIndex() {
		return FreeType.FT_Get_face_index(pointer);
	}

	public String getFamilyName() {
		return FreeType.FT_Get_family_name(pointer);
	}

	public short getHeight() {
		return FreeType.FT_Get_heigth(pointer);
	}

	public short getMaxAdvanceHeight() {
		return FreeType.FT_Get_max_advance_height(pointer);
	}

	public short getMaxAdvanceWidth() {
		return FreeType.FT_Get_max_advance_width(pointer);
	}

	public long getNumFaces() {
		return FreeType.FT_Get_num_faces(pointer);
	}

	public long getNumGlyphs() {
		return FreeType.FT_Get_num_glyphs(pointer);
	}

	public long getStyleFlags() {
		return FreeType.FT_Get_style_flags(pointer);
	}

	public String getStyleName() {
		return FreeType.FT_Get_style_name(pointer);
	}

	public short getUnderlinePosition() {
		return FreeType.FT_Get_underline_position(pointer);
	}

	public short getUnderlineThickness() {
		return FreeType.FT_Get_underline_thickness(pointer);
	}

	public short getUnitsPerEM() {
		return FreeType.FT_Get_units_per_EM(pointer);
	}
