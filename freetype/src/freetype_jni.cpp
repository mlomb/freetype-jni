...
/* --- FreeType functions --- */
JNIEXPORT jobject JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Library_1Version(JNIEnv *env, jclass obj, jlong library) {
...
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1ascender(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->ascender;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1descender(JNIEnv *env, jclass obj, jlong face) {
...
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1face_1index(JNIEnv *env, jclass obj, jlong face) {
...
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1heigth(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->height;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1max_1advance_1height(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->max_advance_height;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1max_1advance_1width(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->max_advance_width;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1num_1faces(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->num_faces;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1num_1glyphs(JNIEnv *env, jclass obj, jlong face) {
...
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1underline_1position(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->underline_position;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1underline_1thickness(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->underline_thickness;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1units_1per_1EM(JNIEnv *env, jclass obj, jlong face) {
...
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Size_1Metrics_1Get_1ascender(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->ascender;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Size_1Metrics_1Get_1descender(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->descender;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Size_1Metrics_1Get_1height(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->height;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Size_1Metrics_1Get_1max_1advance(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->max_advance;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Size_1Metrics_1Get_1x_1ppem(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->x_ppem;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Size_1Metrics_1Get_1x_1scale(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->x_scale;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Size_1Metrics_1Get_1y_1ppem(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->y_ppem;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Size_1Metrics_1Get_1y_1scale(JNIEnv *env, jclass obj, jlong sizeMetrics) {
...
JNIEXPORT jobject JNICALL Java_com_pvporbit_freetype_FreeType_FT_1GlyphSlot_1Get_1advance(JNIEnv *env, jclass obj, jlong glyph) {
...
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Glyph_1Metrics_1Get_1width(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->width;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Glyph_1Metrics_1Get_1height(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->height;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Glyph_1Metrics_1Get_1horiAdvance(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->horiAdvance;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Glyph_1Metrics_1Get_1vertAdvance(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->vertAdvance;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Glyph_1Metrics_1Get_1horiBearingX(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->horiBearingX;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Glyph_1Metrics_1Get_1horiBearingY(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->horiBearingY;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Glyph_1Metrics_1Get_1vertBearingX(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->vertBearingX;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Glyph_1Metrics_1Get_1vertBearingY(JNIEnv *env, jclass obj, jlong glyphMetrics) {
...
JNIEXPORT jintArray JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Get_1First_1Char(JNIEnv *env, jclass obj, jlong face) {
	FT_ULong  charcode;
	FT_UInt   gindex;
...
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Get_1Next_1Char(JNIEnv *env, jclass obj, jlong face, jlong charcode) {
	FT_UInt   gindex;
	FT_Get_Next_Char((FT_Face)face, charcode, &gindex);
	return gindex;
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Get_1Name_1Index(JNIEnv *env, jclass obj, jlong face, jstring name) {
...
JNIEXPORT jlong JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Get_1Track_1Kerning(JNIEnv *env, jclass obj, jlong face, jlong point_size, jint degree) {
	long kern;
	if (FT_Get_Track_Kerning((FT_Face)face, point_size, degree, &kern) != 0)
		return 0;
	return kern;
}
JNIEXPORT jstring JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Get_1Glyph_1Name(JNIEnv *env, jclass obj, jlong face, jint glyphIndex) {
	char* name[100];
	FT_Get_Glyph_Name((FT_Face)face, glyphIndex, name, 100);
	return env->NewStringUTF((const char*)name);
}
JNIEXPORT jstring JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Get_1Postscript_1Name(JNIEnv *env, jclass obj, jlong face) {
	return env->NewStringUTF(FT_Get_Postscript_Name((FT_Face)face));
}
JNIEXPORT jboolean JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Select_1Charmap(JNIEnv *env, jclass obj, jlong face, jint encoding) {
	return FT_Select_Charmap((FT_Face)face, (FT_Encoding)encoding);
}
JNIEXPORT jboolean JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Set_1Charmap(JNIEnv *env, jclass obj, jlong face, jlong charmap) {
	return FT_Set_Charmap((FT_Face)face, (FT_CharMap)charmap);
}
JNIEXPORT jint JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Get_1Charmap_1Index(JNIEnv *env, jclass obj, jlong charmap) {
	return FT_Get_Charmap_Index((FT_CharMap)charmap);
}
JNIEXPORT jshort JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Get_1FSType_1Flags(JNIEnv *env, jclass obj, jlong face) {
	return FT_Get_FSType_Flags((FT_Face)face);
}

JNIEXPORT jobject JNICALL Java_com_pvporbit_freetype_FreeType_FT_1Face_1Get_1Kerning(JNIEnv *env, jclass obj, jlong face, jchar left, jchar right, jint mode) {
	FT_Vector vector;
	int x = 0;
	int y = 0;
	if (!FT_Get_Kerning((FT_Face)face, left, right, mode, &vector)) {
